...
ggplot() +
  geom_pointrange(data = filter(kelp_area3, site_name == 'Fort Ross'),
...
ggplot(data = filter(kelp_area3, site_name == 'Fort Ross'),
            aes(x = year, y = mean_area)) + 
  geom_line() + 
  geom_point() + 
  geom_errorbar(aes(ymin = mean_area - se_area, ymax = mean_area + se_area), width = 0.2) + 
  theme_bw()
