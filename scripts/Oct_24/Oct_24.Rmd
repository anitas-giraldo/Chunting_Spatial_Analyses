...
ggplot(df, aes(x = year, y = fit*factor)) + 
  ...
  scale_y_continuous(name = 'Kelp Area', 
                     sec.axis = sec_axis(~. / factor, name = 'Kelp Density')) + 
  facet_wrap(. ~ resolution, nrow = 2, ncol = 2,
             labeller = labeller(resolution = new.label)) + 
  labs(x = 'Year') + 
  theme_bw() + 
  theme(axis.text.x = element_text(angle = 60, vjust = 0.5, face = 'bold'),
        axis.title.x = element_text(face = 'bold'),
        axis.text.y.left = element_text(color = 'red', face = 'bold'),
        axis.title.y.left = element_text(color = 'red', face = 'bold'),
        axis.text.y.right = element_text(color = 'skyblue', face = 'bold'),
        axis.title.y.right = element_text(color = 'skyblue', face = 'bold', vjust = 2),
        strip.text = element_text(face = 'bold'),
        strip.background = element_rect(colour = 'black', fill = 'white'),
        panel.grid.major.x = element_blank(),
...
plot.area <- function(site) {
  ...
  plot <- ggplot() + 
    geom_bar(data = filter(kelp.density, site_name == site),
             ...
             position = 'dodge', color = 'black', fill = 'skyblue') +
    labs(x = 'Year', 
    ...
    theme(axis.text.x = element_text(angle = 60, vjust = 0.5, size = 20),
          ...
          axis.title.y.right = element_text(color = 'skyblue', face = 'bold', vjust = 1),
          legend.title = element_text(face = 'bold'),
          strip.text = element_text(face = 'bold'),
          strip.background = element_rect(colour = 'black', fill = 'lightgrey'),
          panel.grid.major.x = element_blank(),
