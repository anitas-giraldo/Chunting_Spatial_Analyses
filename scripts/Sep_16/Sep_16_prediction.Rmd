...
preds.dir <- paste(o2.dir, 'sp_predictions_300m', sep ='/')
preds.dir

# output for rasters scaled by rock 
rock.preds.dir <- paste(o2.dir, "sp_predictions_300m_rock", sep ='/')
rock.preds.dir
...
for (i in 1:length(year.list)) {
  ...
  # preds1 <- c(max_nit4[[i+6]], whmax.stack4[[i]], ubr5[[i]], urchin.stack4[[i]])
