...
# disaggregate
max_nit5 <- disagg(max_nit2, fact = 6)
...
# disaggregate 
# whmax.stack5 <- disagg(whmax.stack2, fact = 7)
whmax.stack5 <- whmax.stack2
...
urchin.stack5 <- aggregate(urchin.stack2, fact = 3, fun = mean, na.rm = TRUE)
# urchin.stack5 <- disagg(urchin.stack2, fact = 2)
