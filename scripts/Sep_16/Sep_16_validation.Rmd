...
# r3.dir <- here('spatial_data/sp_predictions_150m_resolution')
# r4.dir <- here('spatial_data/sp_predictions_600m_resolution')
...
```{r}
sites <- unique(kelp_data_900m$site_name) 
...
kelp_longer <- rbind(kelp_longer_900m)
